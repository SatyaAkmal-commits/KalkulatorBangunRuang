...
class HitungKerucut extends StatefulWidget {
  final GeometryModel model;
  const HitungKerucut({super.key, required this.model});

  @override
  State<HitungKerucut> createState() => _HitungKerucutState();
}

class _HitungKerucutState extends State<HitungKerucut> {
